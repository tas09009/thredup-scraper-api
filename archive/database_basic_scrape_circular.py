...
'''
Issue: circular imports and dependencies. See href_scrape_circular.py as the other dependency
'''
...
with alive_bar(len(hrefs)) as bar:
    import href_scrape
    href_scrape_func(hrefs) # scrape all 50 items
    ...
    from href_scrape import basic_scrape
